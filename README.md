...
#### Usuario:
(Todos estos requieren enviar el token proporcionado en autenticación como **USER**)
...
#### Colaboración:
(Todos estos requieren enviar el token proporcionado en autenticación como **COLLAB**)
